...
%
%   Throws:
%       DASH:gridfile:times:invalidGridfile  when grid2 is not a
%           valid gridfile
%       DASH:gridfile:times:invalidAttributes  when attributes is not
%           a recognized option
%       DASH:gridfile:times:invalidType  when type is not a
%           recognized option
%       DASH:gridfile:times:dimensionLengthMismatch  when type is 1
%           or 3 and the data dimensions do not have compatible sizes
%       DASH:gridfile:times:differentMetadata  when type is 1 and
%           there is different metadata along a non-singleton dimension
%       DASH:gridfile:times:noMatchingMetadata  when type is 2 and
%           there is no matching metadata along a non-singleton dimension
%
% <a href="matlab:dash.doc('gridfile.times')">Online Documentation</a>
