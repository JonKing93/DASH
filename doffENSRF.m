function[M] = doffENSRF(M, D, R, H, obsDetails)
...
%
% obsDetails: A two-column matrix with information on each observation.
% Column 1 is an index for the set of observations to which each individual
% observation belongs. Column 2 is the number of previous states recorded
% in the observation. This matrix is generated by the doffSetup.m function.
% 
