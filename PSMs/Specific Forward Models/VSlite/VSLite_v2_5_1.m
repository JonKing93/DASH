function [trw,varargout] = VSLite_v2_5_1(phi,T1,T2,M1,M2,T,P,varargin)
...
if strcmp(hydroclim,'M')
    ...
    if substep == 1
        M = leakybucket_submonthly(nEns,phi,T,P,Mmax,Mmin,alph,m_th,mu_th,rootd,M0);
    elseif substep == 0
        M = leakybucket_monthly(nEns,phi,T,P,Mmax,Mmin,alph,m_th,mu_th,rootd,M0);
