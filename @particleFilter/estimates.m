...
%           current estimates forthe particleFilter object. If you have not
...
%           empty array.
%
% <a href="matlab:dash.doc('particleFilter.estimates')">Documentation Page</a>

% Header
header = "DASH:particleFilter:estimates";
...
if obj.weightType==1 && (strcmpi(type,'set') || strcmpi(type,'delete'))
    obj = varargout{1};
    obj = obj.validateBestN(type, 'estimates', header);
    varargout = {obj};
end
