function [trw,varargout] = VSLite_v2_5(syear,eyear,phi,T1,T2,M1,M2,T,P,varargin)
...
%
% v2.?: Jonathan King: Fixed leaky bucket inputs and adjusted code to
% retain functionality for single year integrations.
