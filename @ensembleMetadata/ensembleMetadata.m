classdef ensembleMetadata
    ...
    properties (Hidden, Constant)
        ...
        nStateFlags = 6;
        copyableFields = {'name','vectorName','variableNames','varLimit','nEls','nEns'};
        vectorFields = {'stateSize','isState','meanSize'};
    end
    ...
    methods
        function obj = ensembleMetadata(sv, name)
            ...
            %
            % obj = ensembleMetadata
            % Creates an empty ensembleMetadata
            %
