function[rst] = section(section, type, summary, headings, files, h1, links, inherited)

% Join the heading blocks
contents = [];
nHeading = numel(headings);
for h = 1:nHeading
    nextblock = format.class.heading(type, headings(h), files{h}, h1{h}, links{h}, inherited{h});
