...
Before we start on the code, we should review some state vector concepts.
...
<img src="\DASH\asserts\images\state-vector.svg" alt="An example state vector." style="width:80%;display:block">
