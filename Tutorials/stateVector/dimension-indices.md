...
Figure 1: Reference indices for June ensemble members.
...
Figure 2: State vector ensemble with June reference indices.
...
Figure 3: Sequence indices pointing to three consecutive Junes.

<img src="\DASH\assets\images\seq-ensemble.svg" alt="An ensemble with a June, July, August sequence down the state vector." style="width:80%;display:block">
Figure 4: State vector ensemble with June reference indices and a three year sequence.
